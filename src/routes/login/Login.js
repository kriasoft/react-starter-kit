  ...
  return (
    <Root>
      <Container maxWidth="380px">
        ...
        <SocialLoginLink
          href="/login/facebook"
          path="M22 16l1-5h-5V7c0-1.544.784-2 3-2h2V0h-4c-4.072 0-7 2.435-7 7v4H7v5h5v14h6V16h4z"
          text="Log in with Facebook"
          background="#3b5998"
          hoverBackground="#2d4373"
        />
        <SocialLoginLink
          href="/login/google"
          path={
