...
###### 2. Add a new app and copy App ID and App Secret.  
...
```
###### 4. Now come back to your app in https://developers.facebook.com. Add it's category in Settings tab and paste ```http://localhost:3000/``` in Site URL.  
