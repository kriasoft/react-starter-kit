...
ALTER TABLE "clara_activesoft_launch_log" ADD CONSTRAINT "clara_activesoft_launch_log_launched_by_user_id_user_id_fk" FOREIGN KEY ("launched_by_user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "clara_individual_student_record" ADD CONSTRAINT "clara_individual_student_record_approved_by_user_id_user_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "clara_review_action" ADD CONSTRAINT "clara_review_action_acted_by_user_id_user_id_fk" FOREIGN KEY ("acted_by_user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
